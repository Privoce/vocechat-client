...
// import 'package:vocechat_client/services/file_handler/audio_msg_handler.dart';
...
//   Future<void> _onMsg(ChatMsgM chatMsgM, dynamic data,
...
//             File? audioFile = data as File?;
//             final audioInfo =
//                 await AudioInfoState.getAudioInfo(chatMsgM, file: audioFile);

//             if (!_localMidSet.contains(localMid)) {
//               _localMidSet.add(localMid);
//               if (frontInsert) {
//                 _uiMsgList.insert(
//                     0, UiMsg(chatMsgM: chatMsgM, audioInfo: audioInfo));
//               } else {
//                 _uiMsgList.add(UiMsg(chatMsgM: chatMsgM, audioInfo: audioInfo));
//               }
//             } else {
//               final index = _uiMsgList.indexWhere(
//                   (element) => element.chatMsgM.localMid == chatMsgM.localMid);
//               if (index > -1) {
//                 _uiMsgList[index].chatMsgM = chatMsgM;
//                 _uiMsgList[index].audioInfo = audioInfo;
//               }
//             }
...
//                 case typeAudio:
//                   final audioInfo =
//                       await AudioInfoState.getAudioInfo(repliedMsg);
//                   if (!_localMidSet.contains(chatMsgM.localMid)) {
//                     _localMidSet.add(chatMsgM.localMid);
//                     _uiMsgList.add(UiMsg(
//                       chatMsgM: chatMsgM,
...
//             element.statusStr != MsgSendStatus.success.name;
//       },
//     );
//     if (mounted) {
//       setState(() {
...
//         if (index > -1) {
//           _uiMsgList[index].chatMsgM.statusStr = MsgSendStatus.sending.name;
//         }
//       });
//     }
...
//           if (index > -1) {
//             _uiMsgList[index].chatMsgM.statusStr = MsgSendStatus.fail.name;
//           }
//         });
//       }
//       return false;
...
//             .indexWhere((element) => element.chatMsgM.localMid == old.localMid);
//         if (index > -1) {
//           _uiMsgList[index].chatMsgM.statusStr = MsgSendStatus.success.name;
//         }
//       });
//     }
//     return true;
...
//                       pinnedBy: pinnedBy,
//                       audioInfo: uiMsg.audioInfo,
//                       repliedAudioInfo: uiMsg.repliedAudioInfo,
//                       onChanged: (selected) {
//                         if (selected) {
//                           selectedMsgMList.value =
...
//                         } else {
//                           selectedMsgMList
//                               .value = List.from(selectedMsgMList.value)
//                             ..removeWhere((element) =>
...
//     final msgStatus = uiMsg.chatMsgM.status;
...
//             case MsgContentType.audio:
//               final filePath =
//                   m.msgNormal?.content ?? m.msgReply?.content ?? "";
//               final chatId =
//                   SharedFuncs.getChatId(uid: m.fromUid, gid: m.gid) ?? "";
//               final audioFile = await AudioMessageHandler()
//                   .readOrFetch(filePath, chatId, m.localMid, (p0, p1) => null);

//               await _onMsg(m, m.localMid, audioFile, frontInsert: false);
