...
class RegisterPasswordPageNew extends StatefulWidget {
  late final BoxDecoration _bgDeco;
  ChatServerM chatServer;
  String? magicToken;
  Uri? invitationLink;

  RegisterPasswordPageNew(
      {Key? key,
  ...
  @override
  State<RegisterPasswordPageNew> createState() =>
      _RegisterPasswordPageNewState();
}

class _RegisterPasswordPageNewState extends State<RegisterPasswordPageNew> {
