...
class UserInfoDetailSettingPage extends StatefulWidget {
  final ValueNotifier<UserInfoM?> userInfoNotifier;

  UserInfoDetailSettingPage(this.userInfoNotifier);

  @override
  State<UserInfoDetailSettingPage> createState() =>
      _UserInfoDetailSettingPageState();
}

class _UserInfoDetailSettingPageState extends State<UserInfoDetailSettingPage> {
